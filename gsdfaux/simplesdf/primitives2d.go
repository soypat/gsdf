...
func Circle(r float64) SDF2 { return wrap2(bld.NewCircle(float32(r))) }

// Rect creates a rectangle with the given x and y dimensions centered at the origin.
func Rect(x, y float64) SDF2 { return wrap2(bld.NewRectangle(float32(x), float32(y))) }

// Hexagon creates a regular hexagon with the given side length.
func Hexagon(side float64) SDF2 { return wrap2(bld.NewHexagon(float32(side))) }

// Ellipse creates an ellipse with semi-axes a (x) and b (y).
func Ellipse(a, b float64) SDF2 { return wrap2(bld.NewEllipse(float32(a), float32(b))) }
...
func Arc(radius, arcAngle, thickness float64) SDF2 {
	return wrap2(bld.NewArc(float32(radius), float32(arcAngle), float32(thickness)))
}
...
func Polygon(points [][2]float64) SDF2 {
	...
	return wrap2(bld.NewPolygon(vecs))
}
